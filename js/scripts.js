...
let createNote = function() {
    let input = document.querySelector('#form-add-note input[type="text"]'); //seletor
...
document.addEventListener('DOMContentLoaded', function (event) { //Carregamento do documento
    ...
    formAddNotes.addEventListener('submit', function (e) {
        e.preventDefault(); //interrompe as ações padrões do DOM
...
document.addEventListener('click', function (e) {
    //console.log(e.target); //exibe o elemento clicado
